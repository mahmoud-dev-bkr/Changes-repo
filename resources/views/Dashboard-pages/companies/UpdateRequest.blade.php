...
@section('content')
    <div class="p-7">
        {!! Form::open(['route' => 'EditRequest', 'class' => 'form-company']) !!}

        <div class="items-center my-2 input-group">
            <label class="font-bold w-80">Name (en)</label>
            <input type="text" class="w-full input bg-base-300/50" value="{{ $company->name_en }}" name="name_en" />
            <input type="text" class="w-full input bg-base-300/50" value="{{ $company->id }}" name="id" hidden/>
        </div>
        <div class="divider"></div>

        <div class="items-center my-2 input-group">
            <label class="font-bold w-80">Name (ar)</label>
            <input type="text" class="w-full input bg-base-300/50" value="{{ $company->name_ar }}" name="name_ar" />
        </div>
        <div class="divider"></div>
        ...
        <div class="items-center my-2 input-group">
            ...
            <input type="email" class="w-full input bg-base-300/50" value="{{ $company->email }}" name="email" />
        </div>
        <div class="divider"></div>

        <div class="items-center my-2 input-group">
            <label class="font-bold w-80">Telephone 1</label>
            <input type="text" class="w-full input bg-base-300/50" value="{{ $company->Tel_1  }}" name="tel1" />
        </div>
        <div class="divider"></div>
        ...
        <div class="items-center my-2 input-group">
            ...
            <input type="text" class="w-full input bg-base-300/50" value="{{ $company->Tel_2  }}" name="tel2" />
        </div>
        <div class="divider"></div>

        <div class="items-center my-2 input-group">
            <label class="font-bold w-80">Telephone 3 (optional)</label>
            <input type="text" class="w-full input bg-base-300/50" value="{{ $company->Tel_3  }}" name="tel3" />
        </div>
        ...
        <div class="items-center my-2 input-group">
            ...
            <input type="text" class="w-full input bg-base-300/50" value="{{ $company->website  }}" name="website" />
        </div>
        ...
        <div class="items-center my-2 input-group">
            ...
            <input type="text" class="w-full input bg-base-300/50" value="{{ $company->main_address }}" name="address" />
        </div>
        ...
        <div class="items-center my-2 input-group">
            ...
            <input type="text" class="w-full input bg-base-300/50" id="lng" value="{{ $company->long }}" name="long" />
        </div>

        <div class="items-center my-2 input-group">
            <label class="font-bold w-80">latitude</label>
            <input type="text" class="w-full input bg-base-300/50" id="lat" value="{{ $company->lat }}" name="lat" />
        </div>
        ...
        <div class="items-center my-4 input-group">
            ...
            <input type="text" class="w-full input bg-base-300/50" id="lng" value="{{ $company->commercial_record }}" name="commercial_record" />
        </div>
        <div class="divider"></div>

        <div class="items-center my-4 input-group">
            <label class="font-bold w-80 arabic">رابط البطاقة الضريبية على الدرايف الخاص بالشركة</label>
            <input type="text" class="w-full input bg-base-300/50" id="lng" value="{{ $company->tax_card }}" name="tax_card" />
        </div>
        ...
        <div class="flex items-center my-4">
            ...
            <div class="relative w-full">
                <input type="text" id="input" class="w-full input bg-base-300/50" value="{{ $company->timezone }}" name="timezone" />
        ...
        <div class="items-center my-4 input-group">
            ...
            <input type="text" class="w-full input bg-base-300/50" id="lng" value="{{ $company->note }}" name="note" />
            <input type="text" class="w-full input bg-base-300/50" id="lng" value="{{ $company->isActive }}" name="isActive" hidden/>
        </div>
        ...
        <div class="items-center my-2 input-group">
            <label class="block font-bold w-80">status Request</label>
            <select name="req_status" class="select select-bordered bg-base-300/50">
        ...
        {{-- <div class="items-center my-2 input-group">
            ...
            <input type="date" class="w-full input bg-base-300/50" value="{{ $company->created_at }}" name="pay_date" />
