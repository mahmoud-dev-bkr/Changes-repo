...
@section('content')
    <div class="p-7">
        {!! Form::open(['route' => 'EditCompany', 'class' => 'form-company']) !!}
        ...
        <div class="items-center my-2 input-group">
            <label class="block font-bold w-80">Status</label>
            <select name="isActive" class="select select-bordered bg-base-300/50">
